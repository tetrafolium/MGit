...
/**
 * NOTE: Using this ONLY UNTIL this PR:
 * https://github.com/facebook/stetho/pull/490 gets merged into Stetho.
 */

/**
 * Timber tree implementation which forwards logs to the Chrome Dev console.
 * This uses a {@link Timber.DebugTree} to automatically infer the tag from the
 * calling class. Plant it using {@link Timber#plant(Timber.Tree)} <pre>
 *   {@code
...
public class ConfigurableStethoTree extends Timber.DebugTree {
  ...
  protected void log(int priority, String tag, String message, Throwable t) {
    ...
    CLog.writeToConsole(logLevel, Console.MessageSource.OTHER,
  ...
  public static class Configuration {
    ...
    public static class Builder {
       ...
       *                 Expects one of constants defined in {@link
       * android.util.Log}. Default is {@link Log#VERBOSE}.
       * @return This {@link Configuration.Builder} instance.
       */
