!function(e) {
  "undefined" != typeof exports
      ? e(exports)
      : (window.hljs = e({}), "function" == typeof define && define.amd &&
                                  define([], function() { return window.hljs }))
}(function(e) {
  function n(e) {
    return e.replace(/&/gm, "&amp;")
        .replace(/</gm, "&lt;")
  ...
  function a(e) {
    var n = (e.className + " " + (e.parentNode ? e.parentNode.className : ""))
                .split(/\s+/);
    return n = n.map(function(e) { return e.replace(/^lang(uage)?-/, "") }),
           n.filter(function(e) { return N(e) || /no(-?)highlight/.test(e) })[0]
  }
  function o(e, n) {
    var t = {};
    for (var r in e)
    ...
    return function r(e, a) {
      for (var o = e.firstChild; o; o = o.nextSibling)
        3 == o.nodeType
            ...
            : 1 == o.nodeType &&
                  (n.push({event : "start", offset : a, node : o}), a = r(o, a),
    ...
    function r(a, i) {
      if (!a.compiled) {
        if (a.compiled = !0, a.k = a.k || a.bK, a.k) {
          ...
          "string" == typeof a.k
              ? u("keyword", a.k)
              : Object.keys(a.k).forEach(function(e) { u(e, a.k[e]) }),
              a.k = c
        }
        ...
        var l =
            a.c.map(function(e) { return e.bK ? "\\.?(" + e.b + ")\\.?" : e.b })
                ...
                .filter(Boolean);
        a.t =
            l.length ? t(l.join("|"), !0) : {exec : function() { return null }}
      }
    }
    r(e)
  }
  function s(e, t, a, o) {
    ...
    function p(e, n, t, r) {
      var a = r ? "" : E.classPrefix, o = '<span class="' + a,
          i = t ? "" : "</span>";
      return o += e + '">', o + n + i
    }
    function d() {
      ...
      for (var r = w.lR.exec(y); r;) {
        ...
        a ? (B += a[1], e += p(a[0], n(r[0]))) : e += n(r[0]),
            t = w.lR.lastIndex, r = w.lR.exec(y)
      }
    ...
    function m(e, t) {
      ...
      if (a) {
        ...
        while (w != a.parent);
        return o.eE && (M += n(t)), y = "", a.starts && b(a.starts, ""),
                                    o.rE ? 0 : t.length
      }
      if (f(t, w))
  ...
  function f(e) {
    return E.tabReplace &&
               (e = e.replace(
                    /^((<[^>]+>|\t)+)/gm,
                    function(e, n) { return n.replace(/\t/g, E.tabReplace) })),
           E.useBR && (e = e.replace(/\n/g, "<br>")), e
  }
  function g(e, n, t) {
    var r = n ? x[n] : t, a = [ e.trim() ];
    return e.match(/(\s|^)hljs(\s|$)/) || a.push("hljs"), r && a.push(r),
           a.join(" ").trim()
  }
  function p(e) {
    var n = a(e);
    if (!/no(-?)highlight/.test(n)) {
      ...
      o.value = f(o.value), e.innerHTML = o.value,
  ...
  var E = {
    ...
    languages : void 0
      ...
      R = {}, x = {};
  return e.highlight = s, e.highlightAuto = l, e.fixMarkup = f,
         e.highlightBlock = p, e.configure = d, e.initHighlighting = h,
         e.initHighlightingOnLoad = v, e.registerLanguage = b,
         e.listLanguages = m, e.getLanguage = N, e.inherit = o,
         e.IR = "[a-zA-Z][a-zA-Z0-9_]*", e.UIR = "[a-zA-Z_][a-zA-Z0-9_]*",
         e.NR = "\\b\\d+(\\.\\d+)?",
         e.CNR =
  ...
  return {
    cI: !0, k: {
      ...
      literal: "A true false NOT AND OR"
        ...
        c: n.concat([
          r, e.inherit(e.QSM, {c : [ r ]}), c, {cN : "number", b : e.NR, r : 0},
          {cN : "var_expand", b : "%", e : "%", i : "\\n", c : [ r ]}, {
            cN : "label",
            c : [ r ],
            v : [ {b : '^[^\\n";]+::(?!=)'}, {b : '^[^\\n";]+:(?!=)', r : 0} ]
...
hljs.registerLanguage("delphi", function(e) {
  var r = "exports register file shl array record property for mod while set ally label uses raise not stored class safecall var interface or private static exit index inherited to else stdcall override shr asm far resourcestring finalization packed virtual out and protected library do xorwrite goto near function end div overload object unit begin string on inline repeat until destructor write message program with read initialization except default nil if case cdecl in downto threadvar of try pascal const external constructor type public then implementation finally published procedure",
      ...
      o = {b : e.IR + "\\s*=\\s*class\\s*\\(", rB : !0, c : [ e.TM ]}, n = {
        ...
        c : [
          e.TM, {cN : "params", b : /\(/, e : /\)/, k : r, c : [ i, c ]}, t
        ]
      };
  return {
    cI: !0, k: r, i: /"|\$[G-Zg-z]|\/\*|<\/|\|/,
        c: [ t, e.CLCM, i, c, e.NM, o, n ]
  }
});
    ...
    k: {
      ...
      literal: "false true null"
        ...
        c: [
          ...
          e.CLCM, e.CBCM, {cN : "string", b : '"""', e : '"""', r : 5}, e.ASM,
          e.QSM, e.CNM, {cN : "preprocessor", b : "^#", e : "$", r : 2},
    ...
    k: {
      ...
      reserved:
        ...
        c: [
          ...
          e.ASM, e.QSM, {cN : "constant", b : "\\?(::)?([A-Z]\\w*(::)?)+"},
          {cN : "arrow", b : "->"}, {cN : "ok", b : "ok"},
...
hljs.registerLanguage("smali", function() {
  ...
  return {
    aliases: [ "smali" ], c: [
      ...
      {cN : "keyword", b : "\\s(" + n.join("|") + ")", r : 1},
      {cN : "keyword", b : "\\[", r : 0},
      {cN : "instruction", b : "\\s(" + r.join("|") + ")\\s", r : 1}, {
        cN : "instruction",
      ...
      built_in:
        ...
        c: [
          ...
          r.ASM, r.QSM, r.CLCM, r.CBCM, r.CNM, {
            ...
            k : "return throw case",
            c : [
              r.CLCM, r.CBCM, r.RM, {b : /</, e : />;/, r : 0, sL : "xml"}
            ],
            r : 0
          },
          {
...
hljs.registerLanguage("cpp", function(t) {
  ...
  return {
    aliases: [ "c", "h", "c++", "h++" ], k: i, i: "</", c: [
      t.CLCM, t.CBCM, t.QSM, {cN : "string", b : "'\\\\?.", e : "'", i : "."},
...
hljs.registerLanguage("oxygene", function(e) {
  var r = "abstract add and array as asc aspect assembly async begin break block by case class concat const copy constructor continue create default delegate desc distinct div do downto dynamic each else empty end ensure enum equals event except exit extension external false final finalize finalizer finally flags for forward from function future global group has if implementation implements implies in index inherited inline interface into invariants is iterator join locked locking loop matching method mod module namespace nested new nil not notify nullable of old on operator or order out override parallel params partial pinned private procedure property protected public queryable raise read readonly record reintroduce remove repeat require result reverse sealed select self sequence set shl shr skip static step soft take then to true try tuple type union unit unsafe until uses using var virtual raises volatile where while with write xor yield await mapped deprecated stdcall cdecl pascal register safecall overload library platform reference packed strict published autoreleasepool selector strong weak unretained",
      t = {cN : "comment", b : "{", e : "}", r : 0},
      a = {cN : "comment", b : "\\(\\*", e : "\\*\\)", r : 10},
      n = {cN : "string", b : "'", e : "'", c : [ {b : "''"} ]},
      o = {cN : "string", b : "(#\\d+)+"}, c = {
        cN : "function",
  ...
  return {
    aliases: [ "graph", "instances" ], cI: !0, k: "import", c: [
      ...
      },
      {
        ...
        c : [
          {cN : "string", b : "\\.[a-zA-Z-_]+", e : "\\s|,|;", eE : !0}, e.HCM
        ]
      },
      e.HCM
    ]
  ...
  return {
    cI: !0, k: {
      ...
      typename:
        ...
        i: "{", c: [
          e.CBCM, {cN : "comment", b : "--", e : "$"}, e.QSM, e.CNM,
...
hljs.registerLanguage("q", function(e) {
  ...
  return {
    aliases: [ "k", "kdb" ], k: s, l: /\b(`?)[A-Za-z0-9_]+\b/,
        c: [ e.CLCM, e.QSM, e.CNM ]
  }
});
hljs.registerLanguage("step21", function(e) {
  var r = "[A-Z_][A-Z0-9_.]*", c = "END-ISO-10303-21;",
      i = {literal : "", built_in : "", keyword : "HEADER ENDSEC DATA"},
      t = {cN : "preprocessor", b : "ISO-10303-21;", r : 10}, l = [
        e.CLCM, {cN : "comment", b : "/\\*\\*!", e : "\\*/", c : [ e.PWM ]},
        e.CBCM, e.CNM, e.inherit(e.ASM, {i : null}),
        e.inherit(e.QSM, {i : null}), {cN : "string", b : "'", e : "'"},
        {cN : "label", v : [ {b : "#", e : "\\d+", i : "\\W"} ]}
      ];
  return {
    aliases: [ "p21", "step", "stp" ], cI: !0, l: r, k: i,
        c: [ {cN : "preprocessor", b : c, r : 10}, t ].concat(l)
  }
});
...
hljs.registerLanguage("smalltalk", function(a) {
  ...
  return {
    aliases: [ "st" ], k: "self super nil true false thisContext", c: [
      ...
      {cN : "array", b : "\\#\\(", e : "\\)", c : [ a.ASM, e, a.CNM, r ]}
    ]
  }
});
hljs.registerLanguage("mercury", function(e) {
  var i = {
    ...
    built_in :
      ...
      t = e.inherit(e.CLCM, {b : "%"}), _ = e.inherit(e.CBCM, {r : 0});
  ...
  return {
    aliases: [ "m", "moo" ], k: i, c: [ s, c, t, _, n, e.NM, a, o, {b : /:-/} ]
  }
});
hljs.registerLanguage("stylus", function(t) {
  var e = {cN : "variable", b : "\\$" + t.IR},
      ...
      d = [
        "\\{", "\\}", "\\?", "(\\bReturn\\b)", "(\\bEnd\\b)", "(\\bend\\b)",
        ";", "#\\s", "\\*\\s", "===\\s", "\\|"
      ];
  return {
    aliases: [ "styl" ], cI: !1, i: "(" + d.join("|") + ")",
        k: "if else for in", c: [
          t.QSM, t.ASM, t.CLCM, t.CBCM, o, {
      ...
      built_in:
        ...
        c:
            [
              ...
              {cN : "preprocessor", b : "<\\?"},
              {cN : "preprocessor", b : "\\?>"}, t, e.ASM, e.QSM, e.BNM, e.CNM,
              a
            ],
        i: ";$|^\\[|^="
  }
  ...
  return {
    aliases: [ "fs" ],
        ...
        c: [
          ...
          {cN : "attribute", b : "\\B('[A-Za-z])\\b", c : [ e.BE ]}, e.CLCM,
...
hljs.registerLanguage("d", function(e) {
  var r = {
    ...
    literal : "false null true"
      ...
      t = "(0|[1-9][\\d_]*)", a = "(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)",
      i = "0[bB][01_]+",
      ...
      N = {cN : "string", b : '[rq]"', e : '"[cwd]?', r : 5},
      m = {cN : "string", b : "`", e : "`[cwd]?"},
      w = {cN : "string", b : 'x"[\\da-fA-F\\s\\n\\r]*"[cwd]?', r : 10},
      A = {cN : "string", b : 'q"\\{', e : '\\}"'},
      F = {cN : "shebang", b : "^#!", e : "$", r : 5},
      y = {cN : "preprocessor", b : "#(line)", e : "$", r : 5},
      L = {cN : "keyword", b : "@[a-zA-Z_][a-zA-Z_\\d]*"},
      v = {cN : "comment", b : "\\/\\+", c : [ "self" ], e : "\\+\\/", r : 10};
  return {
    l: e.UIR, k: r, c: [ e.CLCM, e.CBCM, v, w, p, N, m, A, f, b, g, F, y, L ]
  }
});
    ...
    k: {
      ...
      built_in:
        ...
        i: '(//|"|#|/\\*|\\s+/\\w+)', c: [
          ...
          {b : /\)/, r : 0, starts : s}, {cN : "comment", b : "\\%", e : "$"}
        ].concat(a)
  }
});
hljs.registerLanguage("erb", function() {
  return {
    sL: "xml", subLanguageMode: "continuous", c: [
      {cN : "comment", b : "<%#", e : "%>"},
...
hljs.registerLanguage("dos", function(e) {
  var r = {cN : "comment", b : /@?rem\b/, e : /$/, r : 10}, t = {
    cN : "label",
    b : "^\\s*[A-Za-z._?][A-Za-z0-9_$#@~.?]*(:|\\s+label)",
    r : 0
  };
  return {
    aliases: [ "bat", "cmd" ], cI: !0, k: {
...
hljs.registerLanguage("lisp", function(e) {
  var b = "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#!]*",
      ...
      N = {cN : "variable", b : "\\*", e : "\\*"},
      d = {cN : "keyword", b : "[:&]" + b}, o = {b : c},
      u = {b : "\\(", e : "\\)", c : [ "self", a, l, i ]}, s = {
        cN : "quoted",
        c : [ i, l, N, d, u ],
        v : [
      ...
      f = {cN : "quoted", b : "'" + b}, v = {cN : "list", b : "\\(", e : "\\)"},
      g = {eW : !0, r : 0};
  return v.c = [ {cN : "keyword", v : [ {b : b}, {b : c} ]}, g ],
  ...
  return {
    aliases: [ "ts" ], k: {
      ...
      built_in:
        ...
        c: [
          {cN : "pi", b : /^\s*('|")use strict('|")/, r : 0}, e.ASM, e.QSM,
          e.CLCM, e.CBCM, e.CNM, {
            b : "(" + e.RSR + "|\\b(case|return|throw)\\b)\\s*",
            k : "return throw case",
            c : [
              e.CLCM, e.CBCM, e.RM, {b : /</, e : />;/, r : 0, sL : "xml"}
            ],
            r : 0
          },
          {
    ...
    aliases: [ "ml" ], k: {
      ...
      literal: "true false"
        ...
        i: /\/\/|>>/, l: "[a-z_]\\w*!?", c: [
          ...
          {b : "[a-z_]\\w*'[\\w']*"}, e.inherit(e.ASM, {cN : "char", r : 0}),
...
hljs.registerLanguage("haskell", function(e) {
  var i = {
    ...
    v : [ {b : "--", e : "$"}, {b : "{-", e : "-}", c : [ "self" ]} ]
      ...
      n = {cN : "type", b : "\\b[A-Z][\\w']*", r : 0}, l = {
        cN : "container",
        b : "\\(",
        e : "\\)",
        i : '"',
        c : [
          c, i, a, {cN : "type", b : "\\b[A-Z][\\w]*(\\((\\.\\.|,|\\w+)\\))?"},
  ...
  return {
    aliases: [ "hs" ],
        ...
        c: [
          ...
          {cN : "shebang", b : "#!\\/usr\\/bin\\/env runhaskell", e : "$"}, c,
          i, a, e.QSM, e.CNM, n, e.inherit(e.TM, {b : "^[_a-z][\\w']*"}),
          {b : "->|<-"}
        ]
  }
});
...
hljs.registerLanguage("gcode", function(e) {
  ...
  return {
    aliases: [ "nc" ], cI: !0, l: N, k: i,
        c: [ {cN : "preprocessor", b : c}, r ].concat(t)
  }
});
  ...
  return {
    aliases: [ "capnp" ], k: {
      ...
      literal: "true false"
        ...
        c: [
          t.QSM, t.NM, t.HCM, {cN : "shebang", b : /@0x[\w\d]{16};/, i : /\n/},
          {cN : "number", b : /@\d+\b/}, {
            cN : "class",
            bK : "struct enum",
            e : /\{/,
...
hljs.registerLanguage("livescript", function(e) {
  ...
  return {
    aliases: [ "ls" ], k: t, i: /\/\*/, c: r.concat([
      {cN : "comment", b : "\\/\\*", e : "\\*\\/"}, e.HCM, {
        cN : "function",
        c : [ i, a ],
        rB : !0,
        v : [
...
hljs.registerLanguage("django", function() {
  var e = {
    ...
    c : [
      {cN : "argument", b : /"/, e : /"/}, {cN : "argument", b : /'/, e : /'/}
    ]
  };
  return {
    aliases: [ "jinja" ], cI: !0, sL: "xml", subLanguageMode: "continuous", c: [
      {cN : "comment", b : /\{%\s*comment\s*%}/, e : /\{%\s*endcomment\s*%}/},
      {cN : "comment", b : /\{#/, e : /#}/}, {
        cN : "template_tag",
        b : /\{%/,
        e : /%}/,
...
hljs.registerLanguage("handlebars", function() {
  ...
  return {
    aliases: [ "hbs", "html.hbs", "html.handlebars" ], cI: !0, sL: "xml",
        subLanguageMode: "continuous", c: [ {
          cN : "expression",
          b : "{{",
          e : "}}",
          c : [
            {cN : "begin-block", b : "#[a-zA-Z- .]+", k : e},
            {cN : "string", b : '"', e : '"'},
            {cN : "end-block", b : "\\/[a-zA-Z- .]+", k : e},
...
hljs.registerLanguage("clojure", function(e) {
  var t = {
    built_in :
      ...
      r = "a-zA-Z_\\-!.?+*=<>&#'", n = "[" + r + "][" + r + "0-9/;:]*",
      a = "[-+]?\\d+(\\.\\d+)?", o = {b : n, r : 0},
      s = {cN : "number", b : a, r : 0}, c = e.inherit(e.QSM, {i : null}),
      i = {cN : "comment", b : ";", e : "$", r : 0},
  ...
  return f.c = [ {cN : "comment", b : "comment"}, y, h ], h.c = b, l.c = b, {
  ...
  return t.c.push("self"), {
    aliases: [ "rs" ], k: {
      ...
      built_in:
        ...
        l: e.IR + "!?", i: "</", c: [
          e.CLCM, t, e.inherit(e.QSM, {i : null}),
          {cN : "string", b : /r(#*)".*?"\1(?!#)/},
...
hljs.registerLanguage("lasso", function(e) {
  var r = "[a-zA-Z_][a-zA-Z0-9_.]*", a = "<\\?(lasso(script)?|=)",
      t = "\\]|\\?>", s = {
        literal :
      ...
      l = {cN : "variable", b : "'" + r + "'"}, c = [
        e.CLCM, {cN : "javadoc", b : "/\\*\\*!", e : "\\*/", c : [ e.PWM ]},
        e.CBCM, e.inherit(e.CNM, {b : e.CNR + "|(-?infinity|nan)\\b"}),
        e.inherit(e.ASM, {i : null}), e.inherit(e.QSM, {i : null}),
        {cN : "string", b : "`", e : "`"}, {
          cN : "variable",
          v : [ {b : "[#$]" + r}, {b : "#", e : "\\d+", i : "\\W"} ]
  ...
  return {
    aliases: [ "ls", "lassoscript" ], cI: !0, l: r + "|&[lg]t;", k: s, c: [
      {
        cN : "preprocessor",
        b : t,
        r : 0,
  ...
  return {
    cI: !0, l: "\\.?" + r.IR, k: {
      ...
      preprocessor:
        ...
        c: [
          r.CBCM, {cN : "comment", b : ";", e : "$", r : 0}, r.CNM, r.BNM,
...
hljs.registerLanguage("perl", function(e) {
  var t = "getpwent getservent quotemeta msgrcv scalar kill dbmclose undef lc ma syswrite tr send umask sysopen shmwrite vec qx utime local oct semctl localtime readpipe do return format read sprintf dbmopen pop getpgrp not getpwnam rewinddir qqfileno qw endprotoent wait sethostent bless s|0 opendir continue each sleep endgrent shutdown dump chomp connect getsockname die socketpair close flock exists index shmgetsub for endpwent redo lstat msgctl setpgrp abs exit select print ref gethostbyaddr unshift fcntl syscall goto getnetbyaddr join gmtime symlink semget splice x|0 getpeername recv log setsockopt cos last reverse gethostbyname getgrnam study formline endhostent times chop length gethostent getnetent pack getprotoent getservbyname rand mkdir pos chmod y|0 substr endnetent printf next open msgsnd readdir use unlink getsockopt getpriority rindex wantarray hex system getservbyport endservent int chr untie rmdir prototype tell listen fork shmread ucfirst setprotoent else sysseek link getgrgid shmctl waitpid unpack getnetbyname reset chdir grep split require caller lcfirst until warn while values shift telldir getpwuid my getprotobynumber delete and sort uc defined srand accept package seekdir getprotobyname semop our rename seek if q|0 chroot sysread setpwent no crypt getc chown sqrt write setnetent setpriority foreach tie sin msgget map stat getlogin unless elsif truncate exec keys glob tied closedirioctl socket readlink eval xor readline binmode setservent eof ord bind alarm pipe atan2 getgrent exp time push setgrent gt lt or ne m|0 break given say state when",
      ...
      i = [ e.BE, r, n ], c = [
        n, e.HCM, o, {cN : "comment", b : "^\\=\\w", e : "\\=cut", eW : !0}, s,
        {
          cN : "string",
          c : i,
          v : [
...
hljs.registerLanguage("elixir", function(e) {
  var r = "[a-zA-Z_][a-zA-Z0-9_]*(\\!|\\?)?",
      ...
      c = {cN : "subst", b : "#\\{", e : "}", l : r, k : n}, a = {
        cN : "string",
        c : [ e.BE, c ],
        v : [ {b : /'/, e : /'/}, {b : /"/, e : /"/} ]
      },
      s = {eW : !0, rE : !0, l : r, k : n, r : 0}, i = {
        cN : "function",
        bK : "def defmacro",
        e : /\bdo\b/,
        c : [ e.inherit(e.TM, {b : b, starts : s}) ]
      },
      l = e.inherit(
          i, {cN : "class", bK : "defmodule defrecord", e : /\bdo\b|$|;/}),
      t = [
        a, e.HCM, l, i, {cN : "constant", b : "(\\b[A-Z_]\\w*(.)?)+", r : 0},
        {cN : "symbol", b : ":", c : [ a, {b : b} ], r : 0},
        {cN : "symbol", b : r + ":", r : 0}, {
          cN : "number",
          b : "(\\b0[0-7_]+)|(\\b0x[0-9a-fA-F_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",
          r : 0
...
hljs.registerLanguage("vbscript-html", function() {
  return {
    sL: "xml", subLanguageMode: "continuous",
        c: [ {b : "<%", e : "%>", sL : "vbscript"} ]
  }
});
...
hljs.registerLanguage("twig", function() {
  ...
  return c = c + " " +
             c.split(" ").map(function(e) { return "end" + e }).join(" "),
  {
    aliases: [ "craftcms" ], cI: !0, sL: "xml", subLanguageMode: "continuous",
        c: [
          {cN : "comment", b : /\{#/, e : /#}/},
          {cN : "template_tag", b : /\{%/, e : /%}/, k : c, c : [ r, a ]},
          {cN : "variable", b : /\{\{/, e : /}}/, c : [ r, a ]}
        ]
  }
});
...
hljs.registerLanguage("dust", function() {
  ...
  return {
    aliases: [ "dst" ], cI: !0, sL: "xml", subLanguageMode: "continuous", c: [ {
      cN : "expression",
      b : "{",
      e : "}",
      r : 0,
...
hljs.registerLanguage("scheme", function(e) {
  ...
  return d.c = [ c, l, s, o, u, p, g ], { i: /\S/, c: [ n, l, s, o, p, g ] }
});
...
hljs.registerLanguage("objectivec", function(e) {
  ...
  return {
    aliases: [ "m", "mm", "objc", "obj-c" ], k: t, l: o, i: "</", c: [
...
hljs.registerLanguage("applescript", function(e) {
  var t = e.inherit(e.QSM, {i : ""}),
      r = {cN : "params", b : "\\(", e : "\\)", c : [ "self", e.CNM, t ]}, o = [
        {cN : "comment", b : "--", e : "$"}, {
          cN : "comment",
          b : "\\(\\*",
          e : "\\*\\)",
  ...
  return {
    aliases: [ "osascript" ], k: {
      ...
      property:
        ...
        c:
            [
              t, e.CNM, {cN : "type", b : "\\bPOSIX file\\b"}, {
                cN : "command",
  ...
  return {
    k: {
      ...
      built_in:
        ...
        i: "</", c: [
          e.CLCM, e.CBCM, e.QSM, e.ASM, e.CNM,
          {cN : "preprocessor", b : "#", e : "$"}, {
            cN : "shader",
