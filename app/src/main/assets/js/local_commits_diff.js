...
var commitInfo = function() {
  ...
  var diffBlock = $('<div>', {"class" : 'diff-block'});
  var infoBlock = $('<div>', {"class" : 'info-block'});
  var commitInfoBlock =
      $('<pre>', {"class" : 'commitinfo-block'}).text(commitInfo);
...
$(document).ready(function() { CodeLoader.getDiffEntries(); });
}).call(this);
