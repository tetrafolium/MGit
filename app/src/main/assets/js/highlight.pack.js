var hljs = new function() {
  ...
  function f(q) {
    ...
    function p(y, w) {
      ...
      y.t =
          u.length ? o(u.join("|"), true) : {exec : function(t) { return null }}
    }
    p(q)
  }
  function d(D, E) {
  ...
  function i(q, p, o) {
    if (p) {
      q = q.replace(/^((<[^>]+>|\t)+)/gm,
                    function(r, v, u, t) { return v.replace(/\t/g, p) })
    }
    if (o) {
      q = q.replace(/\n/g, "<br>")
    }
  ...
  function n() {
    ...
    Array.prototype.map.call(document.getElementsByTagName("pre"), b)
        .filter(Boolean)
        .forEach(function(o) { m(o, hljs.tabReplace) })
  }
  function k() {
...
hljs.LANGUAGES.bash = function(a) {
  ...
  return {
    k: {keyword: e, literal: g}, c: [
      {cN : "shebang", b : "(#!\\/bin\\/bash)|(#!\\/bin\\/sh)", r : 10}, c, b,
      a.HCM, h, d, a.inherit(f, {b : "\\[ ", e : " \\]", r : 0}),
      a.inherit(f, {b : "\\[\\[ ", e : " \\]\\]"})
    ]
  }
}(hljs);
hljs.LANGUAGES.erlang = function(i) {
  ...
  var b = {
    ...
    rB : true,
    c : [
      {cN : "record_name", b : "#" + i.UIR, r : 0}, {b : "{", eW : true, r : 0}
    ]
  };
...
hljs.LANGUAGES.rust = function(b) {
  ...
  return {
    k: a, i: "</", c: [
      ...
      {bWK : true, e : "({|<)", k : "iface enum", c : [ d ], i : "\\S"}
    ]
  }
}(hljs);
  ...
  return {
    k: {
      ...
      built_in:
        ...
        i: "</", c: [
          a.CLCM, a.CBLCLM, a.QSM, a.ASM, a.CNM,
          {cN : "preprocessor", b : "#", e : "$"}, {
            cN : "shader",
            bWK : true,
            e : "\\(",
...
hljs.LANGUAGES.markdown = function(a) {
  return {
    c: [
      ...
      {cN : "bullet", b : "^([*+-]|(\\d+\\.))\\s+"},
      {cN : "strong", b : "[*_]{2}.+?[*_]{2}"},
      {cN : "emphasis", b : "\\*.+?\\*"}, {cN : "emphasis", b : "_.+?_", r : 0},
      {cN : "blockquote", b : "^>\\s+", e : "$"}, {cN : "code", b : "`.+?`"},
      {cN : "code", b : "^    ", e : "$", r : 0},
...
hljs.LANGUAGES.lisp = function(i) {
  ...
  var d = [
    {cN : "number", b : l}, {cN : "number", b : "#b[0-1]+(/[0-1]+)?"},
  ...
  var e =
      {cN : "quoted", b : "['`]\\(", e : "\\)", c : d.concat([ h, g, n, b ])};
  var c = {
    cN : "quoted",
    b : "\\(quote ",
    e : "\\)",
...
hljs.LANGUAGES.php = function(a) {
  ...
  var b = [
    a.inherit(a.ASM, {i : null}), a.inherit(a.QSM, {i : null}),
  ...
  return {
    k: "let in if then else case of where do module import hiding qualified type data newtype deriving class instance not as foreign ccall safe unsafe",
        c: [
          ...
          {cN : "string", b : "\\s+'", e : "'", c : [ a.BE ], r : 0}, a.QSM, {
            cN : "import",
            b : "\\bimport",
            e : "$",
          ...
          a.CNM,
          {cN : "shebang", b : "#!\\/usr\\/bin\\/env runhaskell", e : "$"}, d,
          {cN : "title", b : "^[_a-z][\\w']*"}
        ]
  }
}(hljs);
hljs.LANGUAGES["1c"] = function(b) {
  ...
  return {
    cI: true, l: f, k: {keyword: c, built_in: e}, c: [
      b.CLCM, b.NM, d, g, {
        cN : "function",
        b : "(процедура|функция)",
        e : "$",
...
hljs.LANGUAGES.python = function(a) {
  ...
  var d =
      {cN : "params", b : "\\(", e : "\\)", c : [ "self", a.CNM, f ].concat(c)};
  var b = {bWK : true, e : ":", i : "[${=;\\n]", c : [ e, d ], r : 10};
  return {
    k: {
      keyword:
      ...
      built_in: "None True False Ellipsis NotImplemented"
        ...
        i: "(</|->|\\?)", c: c.concat([
          f, a.HCM, a.inherit(b, {cN : "function", k : "def"}),
          a.inherit(b, {cN : "class", k : "class"}), a.CNM,
...
hljs.LANGUAGES.smalltalk = function(a) {
  ...
  return {
    k: "self super nil true false thisContext", c: [
      {cN : "comment", b : '"', e : '"', r : 0}, a.ASM,
        ...
        c: [
          {
            ...
            c : [
              {bWK : true, k : "extends implements"}, {cN : "title", b : a.UIR}
            ]
          },
          a.CLCM, a.CBLCLM, {cN : "string", b : '"""', e : '"""', r : 5}, a.ASM,
          a.QSM, a.CNM, {cN : "preprocessor", b : "^#", e : "$", r : 2},
...
hljs.LANGUAGES.d = function(x) {
  ...
  var c = "(0|[1-9][\\d_]*)", q = "(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)",
      h = "0[bB][01_]+",
  ...
  return {
    l: x.UIR, k: b, c: [ x.CLCM, x.CBLCLM, a, i, w, f, u, t, j, m, s, e, g, d ]
  }
}(hljs);
hljs.LANGUAGES.axapta = function(a) {
  return {
    k: "false int abstract private char interface boolean static null if for true while long throw finally protected extends final implements return void enum else break new catch byte super class case short default double public try this switch continue reverse firstfast firstonly forupdate nofetch sum avg minof maxof count order group by asc desc index hint like dispaly edit client server ttsbegin ttscommit str real date container anytype common div mod",
        c: [
          a.CLCM, a.CBLCLM, a.ASM, a.QSM, a.CNM,
          {cN : "preprocessor", b : "#", e : "$"}, {
            cN : "class",
            bWK : true,
            e : "{",
  ...
  return {
    cI: true, k: {
      ...
      built_in:
        ...
        c: [
          a.CBLCLM, {cN : "comment", b : ";", e : "$"}, a.CNM, a.BNM,
          {cN : "number", b : "\\b(\\$[a-zA-Z0-9]+|0o[0-7]+)"}, a.QSM,
          {cN : "string", b : "'", e : "[^\\\\]'", i : "[^\\\\][^']"},
...
hljs.LANGUAGES.nginx = function(b) {
  var c = [
    {cN : "variable", b : "\\$\\d+"}, {cN : "variable", b : "\\${", e : "}"},
    {cN : "variable", b : "[\\$\\@]" + b.UIR}
  ];
  var a = {
    eW : true,
    ...
    i : "=>",
    c : [
      b.HCM, {cN : "string", b : '"', e : '"', c : [ b.BE ].concat(c), r : 0},
    ...
    k: {
      ...
      reserved:
        ...
        c: [
          ...
          a.ASM, a.QSM, {cN : "constant", b : "\\?(::)?([A-Z]\\w*(::)?)+"},
...
hljs.LANGUAGES.delphi = function(b) {
  ...
  var h = {
    ...
    c : [
      {cN : "title", b : b.IR},
      {cN : "params", b : "\\(", e : "\\)", k : f, c : [ c, d ]}, a, g
    ]
  };
  return {
    cI: true, k: f, i: '("|\\$[G-Zg-z]|\\/\\*|</)', c: [
      a, g, b.CLCM, c, d, b.NM, h, {
        cN : "class",
        b : "=\\bclass\\b",
        e : "end;",
        k : e,
  ...
  return {
    cI: true, k: {
      ...
      literal: "on off"
        ...
        c: [
          a.HCM, {cN : "sqbracket", b : "\\s\\[", e : "\\]$"},
          {cN : "cbracket", b : "[\\$%]\\{", e : "\\}", c : [ "self", b ]}, b,
          {cN : "tag", b : "</?", e : ">"}, a.QSM
        ]
  }
}(hljs);
...
hljs.LANGUAGES.matlab = function(a) {
  var b = [
    a.CNM, {cN : "string", b : "'", e : "'", c : [ a.BE, {b : "''"} ], r : 0}
  ];
  return {
    k: {
      keyword:
        ...
        i: '(//|"|#|/\\*|\\s+/\\w+)', c: [
          {
            ...
            k : "function",
            c : [
              {cN : "title", b : a.UIR}, {cN : "params", b : "\\(", e : "\\)"},
              {cN : "params", b : "\\[", e : "\\]"}
            ]
          },
          {
...
hljs.LANGUAGES.go = function(a) {
  ...
  return {
    k: b, i: "</", c: [
      a.CLCM, a.CBLCLM, a.QSM, {cN : "string", b : "'", e : "[^\\\\]'", r : 0},
      {cN : "string", b : "`", e : "`"}, {
        cN : "number",
