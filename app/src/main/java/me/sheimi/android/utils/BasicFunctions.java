...
public class BasicFunctions {
  ...
  public static void
  showException(@NonNull @NotNull SheimiFragmentActivity activity,
                Throwable throwable, @StringRes final int errorTitleRes,
  ...
  public static void
  showException(@NonNull @NotNull SheimiFragmentActivity activity,
                @NonNull Throwable throwable, @StringRes final int errorRes) {
    showException(activity, throwable, 0, errorRes);
  }

  public static void showException(@NonNull
