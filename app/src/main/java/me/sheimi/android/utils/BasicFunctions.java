...
public class BasicFunctions {
  ...
  public static void setAvatarImage(final ImageView imageView,
                                    final String email) {
    String avatarUri = "";
    if (!email.isEmpty())
  ...
  public static void
  showException(final @NonNull @NotNull SheimiFragmentActivity activity,
                final Throwable throwable, @StringRes final int errorTitleRes,
                @StringRes final int errorRes) {
    ...
    exceptionDialog.show(activity.getSupportFragmentManager(),
                         "exception-dialog");
  }

  public static void showException(final @NonNull
                                   @NotNull SheimiFragmentActivity activity,
