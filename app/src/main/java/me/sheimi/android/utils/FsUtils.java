...
public class FsUtils {
  ...
  /**
   * Get a File representing a dir within the external shared location where
   * files can be stored specific to this app creating the dir if it doesn't
   * already exist
   *
   * @param dirname
   * @return
  ...
  /**
   * Get a File representing a dir within the external shared location where
   * files can be stored specific to this app
   *
   * @param dirname
  ...
  /**
   *
   * Get a File representing a dir within the location where files can be stored
  ...
  /**
   * Get a File representing the location where files can be stored specific to
   * this app
   *
   * @param isExternal if true, will use external *shared* storage
   * @return
  ...
  public static String getMimeType(final String url) {
    ...
    String extension = MimeTypeMap.getFileExtensionFromUrl(
        url.toLowerCase(Locale.getDefault()));
    if (extension != null) {
  ...
  public static void openFile(final SheimiFragmentActivity activity,
                              final File file) {
    ...
    try {
      ...
      try {
        ...
        activity.showMessageDialog(
            ...
            activity.getString(R.string.error_can_not_open_file));
      }
    }
  }
