...
public class CodeGuesser {
  ...
  private final static String[][] FILENAME_EXTENSION_ARRAY = {
      ...
      {"Lisp", "text/x-common-lisp", "lisp", "lsp", "el", "cl", "jl", "L",
       "emacs", "sawfishrc"},
      {"CSS", "text/css", "css"},
  ...
  public static String guessCodeType(final String filename) {
  ...
  public static List<String> getLanguageList() { return mSupportLanguageList; }

  public static String getLanguageTag(final String language) {
    return mDisplayTagMap.get(language);
  }

  public static String wrapUrlScript(final String script) {
    return String.format(URL_SCRIPT_WRAPPER, script);
  }

  public final static String URL_SCRIPT_WRAPPER =
