...
public class SheimiFragmentActivity extends AppCompatActivity {
  ...
  public void
  showOptionsDialog(final int title, final int option_names,
  ...
  public void
  showOptionsDialog(final int title, final CharSequence[] option_values,
                    final onOptionDialogClicked[] option_listeners) {
    AlertDialog.Builder builder = new AlertDialog.Builder(this);
    builder.setTitle(title);
    builder
  ...
  public void
  showEditTextDialog(final int title, final int hint, final int positiveBtn,
