...
public class SheimiFragmentActivity extends AppCompatActivity {
  ...
  public static interface OnBackClickListener { public boolean onClick(); }
  ...
  public void showToastMessage(final String msg) {
    runOnUiThread(new Runnable() {
      @Override
      public void run() {
        Toast.makeText(SheimiFragmentActivity.this, msg, Toast.LENGTH_LONG)
            .show();
      }
    });
  }
  ...
  public void
  showMessageDialog(int title, int msg, int positiveBtn,
  ...
  public void
  showMessageDialog(int title, String msg, int positiveBtn,
                    DialogInterface.OnClickListener positiveListener) {
  ...
  public void
  showMessageDialog(int title, String msg, int positiveBtn, int negativeBtn,
                    DialogInterface.OnClickListener positiveListener,
  ...
  public void
  showOptionsDialog(int title, final int option_names,
  ...
  public void
  showOptionsDialog(int title, CharSequence[] option_values,
                    final onOptionDialogClicked[] option_listeners) {
    AlertDialog.Builder builder = new AlertDialog.Builder(this);
    builder.setTitle(title);
    builder
        .setItems(option_values,
  ...
  public void
  showEditTextDialog(int title, int hint, int positiveBtn,
  ...
  public static interface onOptionDialogClicked { void onClicked(); }
   ...
   * being prompted in the UI in order to connect to a remote repo
   */
  public static interface OnPasswordEntered {

    /**
     * Handle retrying a Remote Repo task after user supplies requested
     * credentials
     *
     * @param username
     * @param password
  ...
  public void rawfinish() { super.finish(); }
  ...
  private void setupImageLoader() {
    DisplayImageOptions mDisplayOptions =
        new DisplayImageOptions.Builder()
            .cacheInMemory(true)
            .cacheOnDisk(true)
            .showImageForEmptyUri(VectorDrawableCompat.create(
                getResources(), R.drawable.ic_default_author, getTheme()))
            .showImageOnFail(VectorDrawableCompat.create(
                getResources(), R.drawable.ic_default_author, getTheme()))
            .build();
