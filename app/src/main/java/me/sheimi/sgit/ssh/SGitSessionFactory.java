...
public class SGitSessionFactory extends JschConfigSessionFactory {
  ...
  protected void configure(Host host, Session session) {
    ...
    // provider that needs to have been initialised with an Android context
    UserInfo userInfo = new CredentialsProviderUserInfo(
        session, SGitApplication.getJschCredentialsProvider());
