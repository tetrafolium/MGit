...
public class PrivateKeyManageActivity
    extends FileExplorerActivity implements ActionMode.Callback {
  ...
  public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
    ...
    case R.id.action_mode_show_private_key: {
      Intent intent =
          new Intent(PrivateKeyManageActivity.this, ViewFileActivity.class);
      intent.putExtra(ViewFileActivity.TAG_FILE_NAME,
                      mChosenFile.getAbsolutePath());
      intent.putExtra(ViewFileActivity.TAG_MODE,
                      ViewFileActivity.TAG_MODE_SSH_KEY);
      mode.finish();
    ...
    case R.id.action_mode_edit_key_password:
      if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {
        ...
        pathArg = new Bundle();
        pathArg.putString(EditKeyPasswordDialog.KEY_FILE_EXTRA,
                          mChosenFile.getAbsolutePath());
        mode.finish();
    ...
    case R.id.action_mode_delete:
      ...
      new AlertDialog.Builder(this)
          ...
          .setMessage(getString(R.string.dialog_key_delete_msg) + " " +
                      mChosenFile)
          .setPositiveButton(
  ...
  private void runActionMode(View view, int position) {
    if (mInActionMode) {
      return;
    }
    ...
    return new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> adapterView, View view,
        ...
        intent.putExtra(
            ViewFileActivity.TAG_FILE_NAME,
            PrivateKeyUtils
                .getPublicKeyEnsure(mFilesListAdapter.getItem(position))
                .getAbsolutePath());
        intent.putExtra(ViewFileActivity.TAG_MODE,
                        ViewFileActivity.TAG_MODE_SSH_KEY);
        startActivity(intent);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    case R.id.action_generate: {
      (new PrivateKeyGenerate())
          .show(getSupportFragmentManager(), "generate-key");
      refreshList();
      return true;
    }
    }
  ...
  public void refreshList() { setCurrentDir(getRootFolder()); }
}
