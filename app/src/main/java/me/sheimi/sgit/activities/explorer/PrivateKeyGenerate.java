...
public class PrivateKeyGenerate extends SheimiDialogFragment {
  ...
  public Dialog onCreateDialog(final Bundle savedInstanceState) {
    ...
    builder.setMessage(R.string.label_dialog_generate_key)
        .setView(view)
        .setPositiveButton(R.string.label_generate_key,
        ...
        .setNegativeButton(
            R.string.label_cancel, new DialogInterface.OnClickListener() {
  ...
  private void generateKey() {
    ...
    File newPubKey =
        new File(PrivateKeyUtils.getPublicKeyFolder(), newFilename);
