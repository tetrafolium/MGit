...
public class ViewFileActivity extends SheimiFragmentActivity {
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    if (mRepo != null) {
      ...
      mCommitsFragment = CommitsFragment.newInstance(
          mRepo, FsUtils.getRelativePath(new File(fileName), mRepo.getDir()));
    }
    if (mRepo == null) {
  ...
  class TabItemPagerAdapter extends FragmentPagerAdapter
    ...
    private final int[] PAGE_TITLE = {R.string.tab_file_label,
