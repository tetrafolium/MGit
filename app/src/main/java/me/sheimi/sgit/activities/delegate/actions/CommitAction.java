...
public class CommitAction extends RepoAction {
  ...
  private void commit(final String commitMsg, final boolean isAmend,
                      final boolean stageAll, final String authorName,
                      final String authorEmail) {
    CommitChangesTask commitTask = new CommitChangesTask(
        mRepo, commitMsg, isAmend, stageAll, authorName, authorEmail,
  ...
  private class Author implements Comparable<Author> {
    ...
    public String displayString() { return mName + " <" + mEmail + ">"; }
    ...
    public boolean equals(final Object o) {
      ...
      return mName.equals(((Author)o).mName) &&
          mEmail.equals(((Author)o).mEmail);
    }
  ...
  private class AuthorsAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(final int position, final View convertView,
      ...
      if (convertView == null) {
        ...
        convertView =
            inflater.inflate(android.R.layout.simple_dropdown_item_1line, null);
      ...
      Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(
          ...
          FilterResults results =
              new FilterResults(); // Holds the results of a filtering operation
                                   // in values
          List<Author> FilteredArrList = new ArrayList<Author>();

          if (mOriginalValues == null) {
            mOriginalValues = new ArrayList<Author>(
  ...
  private void commit() {
    ...
    final AutoCompleteTextView commitAuthor =
        (AutoCompleteTextView)layout.findViewById(R.id.commitAuthor);
    ...
    try {
      Iterable<RevCommit> commits =
          mRepo.getGit().log().setMaxCount(500).call();
      ...
      public void onShow(final DialogInterface dialog) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(final View view) {
            ...
            if (msg.trim().equals("")) {
              commitMsg.setError(
                  mActivity.getString(R.string.error_no_commit_msg));
              return;
            }
            if (!author.equals("")) {
              ltidx = author.indexOf('<');
              if (!author.endsWith(">") || ltidx == -1) {
                commitAuthor.setError(
                    mActivity.getString(R.string.error_invalid_author));
                return;
              }
