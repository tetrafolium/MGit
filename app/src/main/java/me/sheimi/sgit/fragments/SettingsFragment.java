    ...
    mListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
      ...
      public void onSharedPreferenceChanged(
        ...
        if (themePrefKey.equals(key)) {
          // nice trick to recreate the back stack, to ensure existing
          // activities onCreate() are called to set new theme, courtesy of:
          // http://stackoverflow.com/a/28799124/85472
