...
public class CloneTask extends RepoRemoteOpTask {
  ...
  public CloneTask(final Repo repo, final boolean cloneRecursive,
                   final String statusName, final AsyncTaskCallback callback) {
    super(repo);
  ...
  public RepoRemoteOpTask getNewTask() {
    // need to call create repo again as when clone fails due auth error, the
    // repo initially created gets deleted
