...
public class PushTask extends RepoRemoteOpTask {
  ...
  public PushTask(final Repo repo, final String remote, final boolean pushAll,
                  final boolean forcePush, final AsyncTaskCallback callback) {
    super(repo);
    mRemote = remote;
    mCallback = callback;
    mPushAll = pushAll;
  ...
  private void parseRemoteRefUpdate(final RemoteRefUpdate update) {
    ...
    case REJECTED_OTHER_REASON:
      ...
      if (reason == null || reason.isEmpty()) {
        ...
        msg =
            String.format("[%s] Remote ref update was rejected, because %s.\n",
