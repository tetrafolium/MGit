...
public class CheckoutTask extends RepoOpTask {
  ...
  public CheckoutTask(final Repo repo, final String name, final String branch,
  ...
  public void checkoutNewBranch(final String name)
  ...
  public void checkoutFromLocal(final String name)
      throws GitAPIException, JGitInternalException, StopTaskException {
    mRepo.getGit().checkout().setName(name).call();
  }

  public void checkoutFromLocal(final String name, final String branch)
      throws GitAPIException, JGitInternalException, StopTaskException {
    mRepo.getGit()
        .checkout()
  ...
  public void checkoutFromRemote(final String remoteBranchName,
