...
public abstract class RepoOpTask
    extends SheimiAsyncTask<Void, String, Boolean> {
  ...
  protected void onPostExecute(Boolean isSuccess) {
    ...
    if (!isSuccess && !isTaskCanceled()) {
      BasicFunctions.showException(BasicFunctions.getActiveActivity(),
                                   mException, mErrorRes, getErrorTitleRes());
    }
  ...
  protected void setSuccessMsg(int successMsg) { mSuccessMsg = successMsg; }
