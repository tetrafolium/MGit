...
public class RepoFileOperationDialog extends SheimiDialogFragment {
  ...
  public Dialog onCreateDialog(final Bundle savedInstanceState) {
    ...
    builder.setTitle(R.string.dialog_title_you_want_to)
        .setItems(
  ...
  private void
  showRemoveFileMessageDialog(final int dialog_title, final int dialog_msg,
                              final int dialog_positive_button,
                              final DeleteOperationType deleteOperationType) {
    showMessageDialog(
        dialog_title, dialog_msg, dialog_positive_button,
        new DialogInterface.OnClickListener() {
          @Override
          public void onClick(final DialogInterface dialogInterface,
                              final int i) {

            mActivity.getRepoDelegate().deleteFileFromRepo(mFilePath,
                                                           deleteOperationType);
          }
        });
  }
