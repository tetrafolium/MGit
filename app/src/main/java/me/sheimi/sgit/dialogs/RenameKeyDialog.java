...
public class RenameKeyDialog extends SheimiDialogFragment
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    View view =
        mActivity.getLayoutInflater().inflate(R.layout.dialog_rename_key, null);
  ...
  public void onClick(View view) {
    ...
    try {
      PrivateKeyUtils.getPublicKey(mFromFile).renameTo(
          PrivateKeyUtils.getPublicKey(file));
    } catch (Exception e) {
      // TODO
      e.printStackTrace();
    }
