...
public class ImportLocalRepoDialog
    extends SheimiDialogFragment implements View.OnClickListener {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    mPrefsHelper = ((SGitApplication)mActivity.getApplicationContext())
                       .getPrefenceHelper();
