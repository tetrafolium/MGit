...
public final class RepoContract {
  ...
  public static abstract class RepoEntry implements BaseColumns {
    ...
    public static final String COLUMN_NAME_LATEST_COMMITTER_UNAME =
        "latest_committer_uname";
    public static final String COLUMN_NAME_LATEST_COMMITTER_EMAIL =
        "latest_committer_email";
    public static final String COLUMN_NAME_LATEST_COMMIT_DATE =
        "latest_commit_date";
    public static final String COLUMN_NAME_LATEST_COMMIT_MSG =
        "latest_commit_msg";
  ...
  public static final String REPO_ENTRY_CREATE =
      "CREATE TABLE " + RepoEntry.TABLE_NAME + " (" + RepoEntry._ID +
      PRIMARY_KEY_TYPE + COMMA_SEP + RepoEntry.COLUMN_NAME_LOCAL_PATH +
      TEXT_TYPE + COMMA_SEP + RepoEntry.COLUMN_NAME_REMOTE_URL + TEXT_TYPE +
      COMMA_SEP + RepoEntry.COLUMN_NAME_USERNAME + TEXT_TYPE + COMMA_SEP +
  ...
  public static int getRepoID(final Cursor cursor) { return cursor.getInt(0); }
