 ...
 */
@ReportsCrashes(
    mailTo = "mgit@manichord.com", mode = ReportingInteractionMode.TOAST,
    resToastText =
        R.string.crash_toast_text // optional, displayed as soon as the crash
                                  // occurs, before collecting data which can
                                  // take a few seconds
    )
public class SGitApplication extends Application {
  ...
  static { MGitHttpConnectionFactory.install(); }
  ...
  public SecurePrefsHelper getSecurePrefsHelper() { return mSecPrefs; }

  public PreferenceHelper getPrefenceHelper() { return mPrefsHelper; }
