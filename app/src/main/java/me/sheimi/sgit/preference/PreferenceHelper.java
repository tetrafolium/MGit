...
public class PreferenceHelper {
  ...
  /**
   * Returns the root directory on device storage in which new local repos will
   * be stored
   *
  ...
  public File getRepoRoot() {
    String repoRootDir =
        getString(mContext.getString(R.string.pref_key_repo_root_location));
  ...
  public void setRepoRoot(final String repoRootPath) {
    edit(mContext.getString(R.string.pref_key_repo_root_location),
         repoRootPath);
