...
public class SSLProviderInstaller {
  ...
  install(final @SuppressWarnings("unused") Context ctx) {
    if (provider == null) {
    ...
    try {
      ...
      case 1:
        ...
        Field field =
            SSLSocketFactory.class.getDeclaredField("defaultSocketFactory");
        field.setAccessible(true);
        field.set(null, sslContext.getSocketFactory());
        // noinspection JavaReflectionMemberAccess
        field = SSLServerSocketFactory.class.getDeclaredField(
      ...
      // This fallthrough is for the above case a break, and since we want to
      // exclude -1 this is great.
      case -1:
        break;
      default:
        String str =
            "Failed to install security provider MGit_OpenSSL, result: ";
        Timber.e(str + pos);
